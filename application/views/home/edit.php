...
<?php $this->load->view("public/sidebar"); ?>
	...
	<div class="page-content">
		<div class="panel panel-green">
            <div class="panel-heading">编辑分组
				<a type="button"  class="btn btn-primary" style="float: right;margin-right: 10px;margin-top: -7px;" href="<?php echo base_url('home/index')?>">分组列表</a>
            </div>
			...
			<div id="app">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon right">
                        <i class="fa fa-tag"></i>
                        <input value="<?php echo $data['groupname'];?>" class="form-control" disabled="disabled">
                ...
                <div class="form-group">
					...
					<div style="margin-top: 20px;" v-show="show"><!-- display: none; -->
						...
						<my-select 
							...
							v-bind:selectvalue1="todo.checkone"
							v-bind:selectvalue2="todo.checktwo"
							@add="addcompare"
							@del="delcompare"
						...
						<div>
                        	<el-button  type="success"  @click="submitForm('edit')">修改</el-button>
                        	<el-button  type="warning" data-toggle="modal" data-target="#myModal">另存为</el-button>
	                ...
	                <div class="modal-dialog" style="margin-top: 100px;">
	                    <div class="modal-content">
	                        ...
	                        <div class="modal-footer">
	                            <el-button  type="primary"  data-dismiss="modal">取消</el-button>
...
<script type="text/javascript">
	...
	Vue.component('my-select',{
		props: ['compareclass','options','index','selectvalue1','selectvalue2'],
		template:'<div v-bind:class="compareclass.id" style="width:100%;height:50px;" >\
					<div style="float:left;">\
						<el-select v-model="value1" filterable placeholder="请选择" @change="handleChange1">\
						    <el-option\
					...
					<div style="float:left;">\
						<el-select v-model="value2" filterable placeholder="请选择" @change="handleChange2">\
						    <el-option\
						      v-for="item in options"\
						      :key="item.label"\
						      :label="item.label"\
				...
				',
		data: function () {
		    return {show:[''],hidden:['hidden'],value1:this.selectvalue1,value2:this.selectvalue2};
		},
		methods:{
	 		add:function(){
	 			this.$emit('add');
	...
	var vue = new Vue({
		el: '#app',
		data: {
	  		group_name: <?php echo json_encode($data['groupname']);?>,
	  		allsample:[],
        	alldata: <?php echo json_encode($allsample);?>,
        	checkeddata: '',	
        	group:<?php echo json_encode($group);?>,
        	selectop:<?php echo json_encode($selectop);?>,
		...
		methods: {
	 		...
	 		addcompare:function(){
	 			...
	 			newselectop['checkone'] =  '' ;
	 			newselectop['checktwo'] =  '' ;
	 		...
	 		submitForm:function(type){
	 			if(this.checkform()){	
	 				this.$confirm('此操作将修改该分组方案, 是否继续?', '提示', {
